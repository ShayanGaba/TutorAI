  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: '260px', opacity: isOpen ? 1 : 0, transition: 'opacity 200ms ease' }}
      >
        {/* Header */}
        ...
        {/* Mode Selector */}
        <div className="flex-shrink-0 pb-4" style={{ borderBottom: '1px solid var(--border-subtle)' }}>
        ...
        <div className="flex-1 overflow-y-auto py-4 flex flex-col gap-4">
          <ChatHistory
            ...
            onSelect={(item) => { onSelectHistory(item); onClose?.(); }}
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              style={{ color: 'var(--text-muted)', background: showSettings ? 'var(--glass-bg)' : 'transparent' }}
            >
              <Settings size={15} />
            </button>
          </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 text-xs py-1.5 rounded-lg font-medium transition-opacity hover:opacity-80"
                      style={{ background: 'var(--glass-bg)', color: 'var(--text-secondary)', border: '1px solid var(--border-default)' }}
                    >
                      Cancel
                    </button>
                  </div>
